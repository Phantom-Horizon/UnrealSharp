...
void FCSUnrealSharpEditorCommands::RegisterCommands()
{
	...
	UI_COMMAND(HotReload, "Compile C# (Hot Reload)", "Compile managed projects and hot reload modified assemblies.", EUserInterfaceActionType::Button, FInputChord(EKeys::F5, EModifierKey::None));
